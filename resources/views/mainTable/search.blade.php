					...
					<div class="category-sidebar">
						<div class="widget category-list">
	                        ...
	                        <ul class="category-list">
	                            @foreach ( $subcategories_all as $category_all)
	                                    ...
	                                    <div class="product-item bg-light">
	                                        <div class="card">
	                                            <div class="thumb-content">
	                                                @if($company->logo)<a href="{{ route('company', [$company->id]) }}"><img class="card-img-top img-fluid" src="{{ asset(env('UPLOAD_PATH').'/' . $company->logo) }}"/></a>@endif
	                                            </div>
	                                            <div class="card-body">
