...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: Subcategory
        Gate::define('subcategory_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('subcategory_create', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('subcategory_edit', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('subcategory_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('subcategory_delete', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
